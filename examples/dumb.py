...
true_dur_distns = [pyhsmm.distributions.NegativeBinomialIntegerRVariantDuration(np.r_[1.,0.,1.],10.,1.)
...
plt.figure()
plt.plot(truemodel.states_list[0].stateseq,label='truth')
plt.plot(specialmodel.states_list[0].stateseq,label='good guys')
